...
const Hero = () =>  {
  ...
  return (
    <motion.section
      ...
      id="about"
    >
      <div className="absolute w-[14rem] h-[14rem] -z-50 bg-green-100 rounded-full top-0 mt-13 right-0 -mb-16"></div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between md:gap-8 lg:gap-5">
        ...
        >
          ...
          >
            <img
              src="../images/semicolon-picture.jpg"
              alt="Profile picture"
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">
            STANLEY <span className="text-blue-600">UGOCHUKWU</span>
          </h1>
          ...
          <p className="w-full max-w-[30rem] text-[15px] sm:text-[17px] md:text-[20px] text-gray-900 text-justify font-inter">
            I have extensive experience working with Java and SpringBoot, 
            Developing RESTful APIs, and integrating third-party services.
            I have a strong understanding of object-oriented programming,
            data structures, and algorithms. I also casually design with Figma.
          ...
          <div className="socials flex items-center justify-center md:justify-start gap-5">
            ...
            <a
              href="https://www.linkedin.com/in/okonkwo-stanley-7a4a3a177/"
          ...
          <div className="flex space-x-4 justify-center md:justify-start">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              download="OKONKWO STANLEY UGOCHUKWU - CV - Resume (1).pdf"
