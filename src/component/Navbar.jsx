...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-br from-red-950 to-gray-900 p-4 text-white border-b-2 border-dotted">
      <div className="container mx-auto flex justify-between items-center px-5">
        {/* Logo */}
        <div className="text-[32px] font-bold font-pacifico flex flex-row">
          <img src="/images/define-logo.jpg" alt="my-logo" className="w-[2.8rem] h-[2.9rem]" />
          {/* <span className="text-blue-600">S</span>tan */}
        </div>
